                        ...
                        <div class="row py-4 text-end snipcss0-1-1-10">
                            <div class="col snipcss0-2-10-11">
                                <p class="text-3-4 snipcss0-3-11-12" data-lfr-editable-id="card3"
                                    data-lfr-editable-type="rich-text">أنشئت كلية اللغات والترجمة في جامعة العادل لمد
                                    المجتمع بالكوادر المؤهلة والمواكبة للتطورات الحاصلة في حقل اللغات والترجمة التي أصبحت
                                    واحدة من الصفات المميزة للتعليم في القرن الواحد والعشرين في تلك العلوم، مهتدين برؤية
                                    ورسالة الجامعة وسعيا لتحقيق أهداف الجامعة مما يساهم في دفع عجلة التنمية إلى الأمام من
                                    خلال إعطاء الطالب المهارات اللازمة ليصبح عضواً نافعاُ وإنساناً صالحاً لدينه ووطنه ونفسه.

                                    ومن أجل قيام الكلية بدورها في تحقيق أهدافها قامت الكلية بتوفير المتطلبات اللازمة للتعليم
                                    والتعلم والبحث العلمي من خلال استقطاب كوادر تدريسية متميزة وتجهيز بنية تحتية متميزة تشمل
                                    قاعات حديثة ومختبرات لغوية متقدمة ومتخصصة بشاشات ذكية وعدد كبير من الأجهزة والمعدات
                                    اللغوية الحديثة ومكتبة ورقية ورقمية.

                                    تسعى الكلية إلى الاندماج في سوق العمل من خلال دراسة متطلبات السوق وانعكاس ذلك في الخطط
                                    الدراسية واستراتيجيات التعليم والتعلم، كما تسعى الكلية إلى إقامة شراكات مع جامعات محلية
                                    وعالمية من خلال مذكرات التفاهم والتوأمة. كما تسعى الكلية جاهدة إلى تطبيق أفضل معايير
                                    الجودة والاعتماد المؤسسي والبرامجي المحلي والعالمي لضمان حصول الخريج على الكفايات
                        ...
                        <div class="row align-items-xl-center snipcss0-1-1-2">
                            <div class="col-9 snipcss0-2-2-6">
                                <h2 class="font-weight-normal text-6 snipcss0-3-6-7" data-lfr-editable-id="card2"
                                    ...
                                    <strong class="font-weight-extra-bold snipcss0-4-7-9">د. سلال </strong>
                                </h2>
                            </div>
                        </div>
                        <div class="row py-4 text-end snipcss0-1-1-10">
                            <div class="col snipcss0-2-10-11">
                                <p class="text-3-4 snipcss0-3-11-12" data-lfr-editable-id="card3"
                                    ...
                                    أنشئت كلية اللغات والترجمة في جامعة العادل لمد
                                    المجتمع بالكوادر المؤهلة والمواكبة للتطورات الحاصلة في حقل اللغات والترجمة التي أصبحت
                                    واحدة من الصفات المميزة للتعليم في القرن الواحد والعشرين في تلك العلوم، مهتدين برؤية
                                    ورسالة الجامعة وسعيا لتحقيق أهداف الجامعة مما يساهم في دفع عجلة التنمية إلى الأمام من
                                    خلال إعطاء الطالب المهارات اللازمة ليصبح عضواً نافعاُ وإنساناً صالحاً لدينه ووطنه ونفسه.
