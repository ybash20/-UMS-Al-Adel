...
@section('main') --}}
<style>
    @import url('https://fonts.googleapis.com/css?family=lemonad:500,500,300,600,700,800,900,500&display=swap');
...
<div class="content-7d7 p-9o8">
    ...
    <div class="row-lzg py-gy9">
        <div class="col-mdz">
            <p class="text-ar3">
                زوارنا الكرام .. نرحب بكم في موقع كلية علوم الحاسوب وتقنية المعلومات ولا يسعنا هنا الا اعطاءكم نبذة
                صغيرة عن الكلية.
                أنشئت كلية علوم الـحاسوب وتقنية المعلومات في جامعة العادل لمد المجتمع بالكوادر المؤهلة والمواكبة
                للتطورات الحاصلة في حقل علوم الحاسوب وتقنية المعلومات التي أصبحت واحدة من الصفات المميزة للتعليم في
                القرن الواحد والعشرين في تلك العلوم مهتدين برؤية ورسالة الجامعة وسعيا لتحقيق اهداف الجامعة مما يساهم في
                دفع عجلة الـــتنمية الى الأمام من خــلال إعطاء الطــــالب الــمهارات اللازمة ليصبح عضواً نافعاُ وإنساناً
                صالحاً لــدينه ووطنه ونفسه.
                ومن اجل قيام الكلية بدورها في تحقيق أهدافها قامت الكلية بتوفير المتطلبات اللازمة للتعليم والتعلّم والبحث
                العلمي من خلال استقطاب كوادر تدريسية متميزة وتجهيز بنية تحتية متميزة تشمل قاعات حديثة ومختبرات متقدمة
                ومتخصصة بشاشات ذكية وعدد كبير من أجهزة الحاسوب المتقدمة وملحقاتها ومكتبة ورقية ورقمية.
                تسعى الكلية إلى الاندماج في سوق العمل من خلال دراسة متطلبات السوق وانعكاس ذلك في الخطط الدراسية
                واستراتيجيات التعليم والتعلم، كما وتسعى الكلية إلى إقامة شراكات مع جامعات محلية وعالمية من خلال مذكرات
                التفاهم والتوأمة. كما تسعى الكلية جاهدة إلى تطبيق أفضل معايير الجودة والاعتماد المؤسسي والبرامجي المحلي
                والعالمي لضمان حصول الخريج على الكفايات المطلوبة لمواكبة تطورات هذا العصر.
