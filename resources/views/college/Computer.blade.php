                        ...
                        <div class="row py-4 text-end snipcss0-1-1-10">
                            <div class="col snipcss0-2-10-11">
                                <p class="text-3-4 snipcss0-3-11-12" data-lfr-editable-id="card3"
                                    ...
                                    الحضارية الكبيرة التي أدخلها الحاسوب على العالم. ففي غضون سنوات قليلة دخلت الإنترنت
                                    إلى
                                    وعي
                                    كثير من الناس وصارت هذه الشبكة المتصلة بمئات الملايين من الحواسيب عبر العالم وسيلة
                                    للتواصل
                                    ونقل المعلومات بين أطراف العالم المترامية بحرية وبسرعة فائقة. وبلا ريب أن هذه
                                    المعلومات
                                    المتداولة تحتوي مضامين مختلفة تشكل ثقافة الإنسان وتدير دفة حضارة المجتمعات. ففي ضوء
                                    هذا
                                    الادراك لأهمية الحاسوب وتقنية المعلومات فقد حرصت جامعة نجران منذ نشأتها على إطلاق
                                    برامج
                        ...
                        <div
                            ...
                            <div class="row py-4 text-end snipcss0-1-1-10">
                                <div class="col snipcss0-2-10-11">
                                    <p class="text-3-4 snipcss0-3-11-12" data-lfr-editable-id="card3"
                                        data-lfr-editable-type="rich-text">
                                        	رفد المجتمع بمتخصصين في مجالات الحاسوب والمعلومات ذوي كفاءة عالية قادرين على التعامل مع المشاكل التخصصية المختلفة
                                        	إنشاء شراكة فاعلة مع القطاع الحكومي وقطاع الاعمال وباقي المؤسسات ذات العلاقة لضمان مخرجات تعليمية فعالة وموجهة نحو تحقيق الأهداف ومتسقة مع احتياجات تلك القطاعات.
                                        	تطوير العلاقات وتبادل الخبرات مع كليات المعنية في الجامعات المختلفة محليا وإقليميا بما ينعكس على تطوير برامج الكلية وفق متطلبات الجودة والاعتماد الأكاديمي.
                                        	تعزيز دور الكلية في خدمة المجتمع المحلي والمساهمة في تنميته من خلال تقديم برامج متجددة.
                                        	تحسين قدرات الطلاب الدراسية المهنية والتنافسية وتشجيع البحث العلمي والتعليم الذاتي المستمر.
