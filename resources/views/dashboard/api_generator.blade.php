...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class='active'><a href="{{ UMS::mainpath('generator') }}"><i class='fa fa-cog'></i> API Generator</a></li>
    </ul>
            ...
            @push('bottom')
                <script>
                    ...
                    function load_response() {
                        ...
                        no_params = 0;
                        $.get('{{url(config("ums.ADMIN_PATH"))."/api_generator/column-table"}}/' + t + '/' + type, function (resp) {
