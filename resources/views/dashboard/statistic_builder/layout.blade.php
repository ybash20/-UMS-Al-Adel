...
<head>
    ...
    <link rel="shortcut icon"
          href="{{ UMS::getSetting('favicon')?asset(UMS::getSetting('favicon')):asset('vendor/ums/assets/logo50.png') }}">
        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="{{url(config('ums.ADMIN_PATH'))}}" title='{{Session::get('appname')}}'
                       class="navbar-brand">{{UMS::getSetting('appname')}}</a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{UMS::mainpath()}}"><i class='fa fa-sign-out'></i> Exit</a></li>
                    </ul>
                </div>
                <!-- /.navbar-custom-menu -->
            </div>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-smallbox' class='button-widget-area'>
                    <a href="#" data-component='smallbox' class='btn-add-widget add-small-box'>
                        <img src='{{asset("vendor/ums/assets/statistic_builder/smallbox.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-table' class='button-widget-area'>
                    <a href="#" data-component='table' class='btn-add-widget add-table'>
                        <img src='{{asset("vendor/ums/assets/statistic_builder/table.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-chartarea' class='button-widget-area'>
                    <a href="#" data-component='chartarea' class='btn-add-widget add-chart-area'>
                        <img src='{{asset("vendor/ums/assets/statistic_builder/chart_area.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-panelarea' class='button-widget-area'>
                    <a href="#" data-component='panelarea' class='btn-add-widget add-panel-area'>
                        <img src='{{asset("vendor/ums/assets/statistic_builder/panel.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-chartarea' class='button-widget-area'>
                    <a href="#" data-component='chartline' class='btn-add-widget add-chart-line'>
                        <img src='{{asset("vendor/ums/assets/statistic_builder/chart_line.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-chartarea' class='button-widget-area'>
                    <a href="#" data-component='chartbar' class='btn-add-widget add-chart-bar'>
                        <img src='{{asset("vendor/ums/assets/statistic_builder/chart_bar.png")}}'/>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
      ...
      user experience -->
<!-- SlimScroll 1.3.0 -->
<script src="{{ asset('vendor/ums/assets/adminlte/plugins/slimScroll/jquery.slimscroll.min.js')}}"></script>
