...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="{{ UMS::mainpath() }}"><i class='fa fa-file'></i> API Documentation</a></li>
        <li><a href="{{ UMS::mainpath('screet-key') }}"><i class='fa fa-key'></i> API Secret Key</a></li>
            ...
            @push('bottom')
                <script>
                    ...
                    function deleteApi(id) {
                        var url = "{{url(config('ums.ADMIN_PATH').'/api_generator/delete-api')}}/" + id;
                        swal({
                            title: "Are you sure?",
            ...
            <table class='table table-striped table-api table-bordered'>
                ...
                <tr class='info'>
                    ...
                    <th>API Name
                      ...
                      <a class='btn btn-xs btn-warning' target="_blank" href='{{UMS::mainpath("download-postman")}}'>Export For POSTMAN <sup>Beta</sup></a>
                    </span>
                    </th>
                </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <sup>
                                ...
                                &nbsp; <a title='Edit This API' href="{{url(config('ums.ADMIN_PATH').'/api_generator/edit-api').'/'.$api->id}}"><i
