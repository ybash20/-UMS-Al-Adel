...
@section("content")
    ...
    @endphp
    @push('head')
        <link rel='stylesheet' href='<?php echo asset("vendor/ums/assets/select2/dist/css/select2.min.css")?>'/>
        <style>
    ...
    @endpush
    @push('bottom')
        <script src='<?php echo asset("vendor/ums/assets/select2/dist/js/select2.full.min.js")?>'></script>
        <script>
            $(function () {
                $('.select2').select2();
            })
    ...
    @push('bottom')
        <script>
            ...
            function showTableFieldLike(t) {
                ...
                $.get("{{UMS::mainpath('table-columns')}}/" + table, function (response) {
                    t.next("ul").remove();
                    var list = '';
    ...
    <div class="box box-default">
                ...
                <table class="table-display table table-striped">
                    ...
                    @if($cb_col)
                        @foreach($cb_col as $c)
                            <tr>
                                <td>
                                    <input value='{{$c["label"]}}' type='text' name='column[]' onclick='showColumnSuggest(this)' onKeyUp='showColumnSuggestLike(this)' placeholder='Column Name' class='column form-control notfocus' value=''/></td>
                                <td>
                                    <input value='{{$c["name"]}}' type='text' name='name[]' onclick='showNameSuggest(this)' onKeyUp='showNameSuggestLike(this)' placeholder='Field Name' class='name form-control notfocus' value=''/>
                                </td>
                                <td>
                                ...
                                <td>
                                    <select class='form-control is_download' name='is_download[]'>
                                        <option {{ (!$c['download'])?"selected":""}} value='0'>
                                            N
                                        </option>
                                        <option {{ ($c['download'])?"selected":""}} value='1'>
                                            Y
                                        </option>
                                    </select>
                                </td>
        ...
        <div class="box-footer">
            <div align="right">
                <button type="button" onclick="location.href='{{UMS::mainpath('step1').'/'.$id}}'" class="btn btn-default">&laquo; Back</button>
