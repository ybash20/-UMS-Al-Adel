...
?>
@if(file_exists(base_path('/resources/views/dashboard/default/type_components/'.$type.'/component.blade.php')))
    @include('dashboard.default.type_components.'.$type.'.component')
@elseif(file_exists(resource_path('views/vendor/ums/type_components/'.$type.'/component.blade.php')))
    @include('vendor.ums.type_components.'.$type.'.component')
@else
