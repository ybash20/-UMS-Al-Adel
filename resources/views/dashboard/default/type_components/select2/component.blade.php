                ...
                <script>
                    $(function () {
                        $('#{{$name}}').select2({
                            placeholder: {
                                id: '-1',
                                text: '{{lang('text_prefix_option')}} {{$form['label']}}'
                            },
                            allowClear: true,
                            ajax: {
                                url: '{!! $url !!}',
            ...
            @if(isset($form['datatable']))
                @if(isset($form['relationship_table']))
                    ...
                    if(isset($form['datatable_orig']) && $form['datatable_orig'] != ''){
                        ...
                        $foreignKey = UMS::getForeignKey($table, $form['relationship_table']);
                        $foreignKey2 = UMS::getForeignKey($select_table, $form['relationship_table']);
