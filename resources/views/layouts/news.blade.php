            ...
            <div class="content-lga mx-tka">
                <div class="row-qk7 pt-iso">
                    <div class="col-gb5 px-5jw mb-g7w">
                        ...
                        <div class="card_p">
                            <p class="news_post_p">أبرز الأخبار الصحفية والتغطيات الإعلامية للفعاليات والأحداث الجامعية أبرز الأخبار الصحفية والتغطيات الإعلامية للفعاليات والأحداث الجامعيةأبرز الأخبار الصحفية والتغطيات الإعلامية للفعاليات</p>
                        </div>
                    </div>
                    <div class="col-gb5 px-5jw mb-g7w list-i5d">
                        <div class="post-217 pt-iso d-q8z item-oe3">
                            ...
                            <div class="content-lao"> <a class="news_a" href="/news0028">سعادة رئيس الجامعة الإسلامية المكلف
                                ...
                                <p class="news_post_p">أبرز الأخبار الصحفية والتغطيات الإعلامية للفعاليات والأحداث الجامعيةأبرز الأخبار الصحفية والتغطيات الإعلامية للفعاليات والأحداث الجامعيةأبرز الأخبار الصحفية والتغطيات الإعلامية للفعاليات</p>
                            </div>
                        </div>
                        <div class="post-217 pt-iso d-q8z item-oe3">
                            <div class="post-231">
                        ...
                        <div class="col-sp4 my-4nd text-oqa">
                            <a class="news_a btn-31z btn-primary-zq4 btn-84b w-ay8" href="/university/newses">المزيد</a>
                        </div>
                    </div>
                </div>
            </div>
