        ...
        <footer class="footer">
          <div class="region region-footer">
            <div id="block-socialmedialinks"
              ...
              <ul class="social-media-links--platforms platforms inline horizontal">
                <li>
                  <a class="social-media-link-icon--twitter" href="https://www.twitter.com/_KSU" target="_blank"
                    rel="nofollow">
                ...
                <li>
                  <a class="social-media-link-icon--tiktok" href="https://www.tiktok.com/@ksu1957" target="_blank"
                    rel="nofollow">
                    <span class="fab fa-tiktok fa-lg"></span>
                  </a>
                </li>
                <li>
                  <a class="social-media-link-icon--instagram" href="https://www.instagram.com/king_saud_university"
                    target="_blank" rel="nofollow">
                ...
                <li>
                  <a class="social-media-link-icon--youtube" href="https://www.youtube.com/user/pdksuchannel"
                    target="_blank" rel="nofollow">
                ...
                <div class="footer-inner">
                  ...
                  <div class="section contacts">
                    <div class="section_content_container">
                      ...
                      <ul class="section_list">
                        <li>
                          <a href="https://ksu.edu.sa/ar/node/3043"><span>السياسات والأنظمة</span></a>
                        </li>
                        <li>
                          <a href="https://ksu.edu.sa/ar/sustainability"><span>الاستدامة</span></a>
                        </li>
                        <li>
                  ...
                  <div class="section stars">
                    <a href="https://www.topuniversities.com/universities/king-saud-university" rel="noreferrer" target="_blank">
                      <img alt="" aria-hidden="true" data-entity-type="" data-entity-uuid="" src="images\Logo.png" />
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="region region-bottom-footer">
            <div id="block-copyrightfooter" class="copyright-footer block block-copyright-footer">
              حقوق &copy; 1957-2024 جميع الحقوق محفوظة . جامعة الملك سعود.
            </div>
            <nav role="navigation" aria-labelledby="block-footer-menu" id="block-footer"
              ...
              <ul data-block="bottom_footer" class="nav navbar-nav">
                <li class="nav-item">
                  <a href="ar/copyright.html" class="nav-link" data-drupal-link-system-path="node/3070">حقوق النشر
                  </a>
                </li>
                <li class="nav-item">
                  <a href="ar/privacy.html" class="nav-link" data-drupal-link-system-path="node/2921">سياسة الخصوصية
                  </a>
                </li>
                <li class="nav-item">
                  <a href="ar/terms.html" class="nav-link" data-drupal-link-system-path="node/3071">شروط الاستخدام</a>
                </li>
              </ul>
            </nav>
          </div>
