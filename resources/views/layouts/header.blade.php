@section('navbar')
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(fonts/readex/readex1.woff2) format('woff2');
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(fonts/readex/readex2.woff2) format('woff2');
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(fonts/readex/readex3.woff2) format('woff2');
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url(fonts/readex/readex4.woff2) format('woff2');
