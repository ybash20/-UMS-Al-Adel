                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-{{ cbLang('right') }}">
                                ...
                                <a href="javascript:void(0)" id="logoutButton" title="{{cbLang('button_logout')}}" class="btn btn-danger btn-flat">
