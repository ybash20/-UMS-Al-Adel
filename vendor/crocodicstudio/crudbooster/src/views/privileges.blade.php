            ...
            <form method='post' action='{{ (@$row->id)?route("PrivilegesControllerPostEditSave")."/$row->id":route("PrivilegesControllerPostAddSave") }}'>
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <strong>
                            {{ cbLang('privilege_helper') }}
                        </strong>
                    </div>
                    <div class='form-group'>
                        <label>
                            {{cbLang('privileges_name')}}
                        </label>
                    ...
                    <div id='privileges_configuration' class='form-group'>
                        <label>
                            {{ cbLang('privileges_configuration') }}
                        </label>
                        @push('bottom')
                            <script>
                                $(function () {
                        ...
                        <table class='table table-striped table-hover table-bordered'>
                            ...
                            <tr class='active'>
                                <th width='3%'>
                                    {{cbLang('privileges_module_list_no')}}
                                </th>
                                <th width='60%'>
                                    {{cbLang('privileges_module_list_mod_names')}}
                                </th>
                                <th>
                                    &nbsp;
                                </th>
                                <th>
                                    {{cbLang('privileges_module_list_view')}}
                                </th>
                                <th>
                                    {{cbLang('privileges_module_list_create')}}
                                </th>
                                <th>
                                    {{cbLang('privileges_module_list_read')}}
                                </th>
                                <th>
                                    {{cbLang('privileges_module_list_update')}}
                                </th>
                                <th>
                                    {{cbLang('privileges_module_list_delete')}}
                                </th>
                            </tr>
                            <tr class='info'>
                                <th>
                ...
                <div class="box-footer" align="right">
                    <button type='button' onclick="location.href='{{CRUDBooster::mainpath()}}'" class='btn btn-default'>{{cbLang("button_cancel")}}</button>
