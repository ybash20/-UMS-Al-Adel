...
class AdminMajorsController extends UMSController
{
    public function cbInit()
    {
        ...
        $this->col[] = ["label" => "College","name" => "College_ID","join" => "colleges,Name_Arabic","width" => "250"];
        $this->col[] = ["label" => "Degree Level","name" => "Degree_Level_ID","join" => "degree_levels,Name_Arabic","width" => "250"];
        ...
        $this->form[] = ['label' => 'Courses','name' => 'Courses','type' => 'wysiwyg','width' => 'col-sm-9'];
        $this->form[] = ['label' => 'Time table','name' => 'Timetable','type' => 'wysiwyg','width' => 'col-sm-9'];
        ...
        //$this->form[] = ['label'=>'Description Arabic','name'=>'Description_Arabic','type'=>'wysiwyg','width'=>'col-sm-9'];
        //$this->form[] = ['label'=>'Description English','name'=>'Description_English','type'=>'wysiwyg','width'=>'col-sm-9'];
        //$this->form[] = ['label'=>'Courses','name'=>'Courses','type'=>'wysiwyg','validation'=>'image','width'=>'col-sm-9'];
        //$this->form[] = ['label'=>'Time table','name'=>'Timetable','type'=>'wysiwyg','validation'=>'image','width'=>'col-sm-9'];
        # OLD END FORM
