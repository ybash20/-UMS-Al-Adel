<?php namespace App\Http\Controllers;
	...
	class AdminIdentitiesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Issuing Authority","name"=>"Issuing_Authority"];
			...
			//$this->form[] = ["label"=>"Issuing Authority","name"=>"Issuing_Authority","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
