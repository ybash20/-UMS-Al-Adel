<?php namespace App\Http\Controllers;
	...
	class AdminGuardiansController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Registration","name"=>"Registration_ID","join"=>"registrations,id"];
			$this->col[] = ["label"=>"Name","name"=>"Name"];
			$this->col[] = ["label"=>"Relationship","name"=>"Relationship"];
			$this->col[] = ["label"=>"Profession","name"=>"Profession"];
			$this->col[] = ["label"=>"Workplace","name"=>"Workplace"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Registration ID","name"=>"Registration_ID","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Name","name"=>"Name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Relationship","name"=>"Relationship","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Profession","name"=>"Profession","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Workplace","name"=>"Workplace","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
