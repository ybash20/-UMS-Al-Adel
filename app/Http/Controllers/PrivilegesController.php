...
class PrivilegesController extends UMSController
{
    ...
    public function getAdd()
    {
        ...
        return view('dashboard.privileges', $data);
    }
    ...
    public function getEdit($id)
    {
        ...
        if (! UMS::isRead() && $this->global_privilege == false) {
        ...
        $page_title = lang('edit_data_page_title', ['module' => 'Privilege', 'name' => $row->name]);

        $moduls = DB::table("ums_moduls")->where('is_protected', 0)->where('deleted_at', null)->select("ums_moduls.*")->orderby("name", "asc")->get();
        $page_menu = Route::getCurrentRoute()->getActionName();

        return view('dashboard.privileges', compact('row', 'page_title', 'moduls', 'page_menu'));
    }
    ...
    public function postEditSave($id)
    {
        ...
        UMS::redirect(UMS::mainpath(), lang("alert_update_data_success", [
            'module' => "Privilege",
            'title' => $row->name,
        ]), 'success');
    }
    ...
    public function getDelete($id)
    {
        ...
        UMS::redirect(UMS::mainpath(), lang("alert_delete_data_success"), 'success');
    }
}
